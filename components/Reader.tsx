              ...
              if (startsWithNumber) {
                return (
                  <div 
                    ...
                    className={`relative p-6 -mx-6 my-4 rounded-[24px] cursor-pointer transition-all duration-300 group/slide border-l-4 ${
                      activeSlideIndex === sIdx 
                        ? 'bg-teal-600/10 dark:bg-teal-600/20 border-teal-600 shadow-lg' 
                  ...
                  >
                    <div className="absolute -left-16 top-6 opacity-0 group-hover/slide:opacity-100 transition-opacity">
                      <Presentation className={`w-6 h-6 ${activeSlideIndex === sIdx ? 'text-teal-600' : 'text-zinc-400'}`} />
                    </div>
